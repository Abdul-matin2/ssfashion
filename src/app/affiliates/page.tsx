      ...
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div>
          ...
          <p className="text-lg text-neutral-600 leading-relaxed">
            We&apos;re building an exciting affiliate program. Earn commissions by sharing S&S Fashion with your audience, coming soon.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 p-6 space-y-4 text-left">
          ...
          <ul className="space-y-3 text-neutral-600 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span>Competitive commission rates on every sale</span>
            </li>
            <li className="flex items-start gap-3">
              <svg className="h-5 w-5 text-brand-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span>Easy-to-use dashboard with real-time tracking</span>
            </li>
            <li className="flex items-start gap-3">
              <svg className="h-5 w-5 text-brand-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span>Marketing materials and creatives provided</span>
            </li>
            <li className="flex items-start gap-3">
              <svg className="h-5 w-5 text-brand-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span>Monthly payouts with detailed reports</span>
            </li>
          </ul>
        </div>
