        ...
        <div className="bg-white rounded-2xl border border-neutral-200 p-6 md:p-8">
          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-center gap-3 text-neutral-600">
              <svg className="h-5 w-5 flex-shrink-0 text-brand-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <a href={`mailto:${contact.email}`} className="text-brand-gold hover:text-brand-gold/80 font-medium transition-colors">
                {contact.email}
              </a>
            </div>
            <div className="flex items-center gap-3 text-neutral-600">
              ...
              <a href={`tel:${contact.phone}`} className="text-brand-gold hover:text-brand-gold/80 font-medium transition-colors">
                {contact.phone}
              </a>
            </div>
          </div>
