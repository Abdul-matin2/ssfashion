      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Logo size="lg" color="light" className="mb-6" />
            <p className="text-neutral-400 text-sm leading-relaxed mb-6">
              Your destination for authentic branded shoes, sneakers, slides, and boots. Quality footwear for every step of your journey.
            </p>
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-neutral-400 hover:text-brand-gold transition-colors duration-200"
            ...
            <ul className="space-y-3">
              {footerLinks.shop.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-neutral-400 hover:text-brand-gold transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-neutral-500 text-sm">
              © 2026 S&S Fashion. All Rights Reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link
                href="/terms"
                className="text-neutral-500 hover:text-brand-gold transition-colors text-sm"
              >
                Terms of Service
              </Link>
              <Link
